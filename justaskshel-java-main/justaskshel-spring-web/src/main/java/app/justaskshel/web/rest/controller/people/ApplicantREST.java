package app.justaskshel.web.rest.controller.people;

import app.justaskshel.business.repo.people.ApplicantRepository;
...
class ApplicantREST {
    private static final String ENDPOINT_ROOT = RESTModule.API_LEADS_PREFIX + "/applicants";
    //
